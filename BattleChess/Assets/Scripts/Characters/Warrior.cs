...
public class Warrior : CarrerManager
{
    ...
    public Skill FireStrike = new Skill(SkillType.AllRoundAttack, AttackRangeType.Straight,"FireStrick", 1, 20, 2, 1.2f, allRoundAttackParams: new AllRoundAttackParams { icedamage = 0, firedamage = 10, damage = 5, buffType = "Ignited", buffDuration = 2 });
